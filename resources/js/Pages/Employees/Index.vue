...
const openModal = (op, name, email, phone, department, employee) => {
  ...
  id.value = employee;
  if (op == 1) {
    title.value = "Crear material";
  } else {
    title.value = "Editar material";
    form.name = name;
    form.email = email;
    form.phone = phone;
...
const ok = (msj) => {
  form.reset();
  closeModal();
  Swal.fire({ title: msj, icon: "exitoso" });
};
...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <Modal :show="modal" @close="closeModal">
      ...
      <div class="p-3">
        <InputLabel for="email" value="Descripción:"></InputLabel>
        <TextInput
          id="email"
          v-model="form.email"
          type="text"
      ...
      <div class="p-3">
        <InputLabel for="phone" value="Cantidad:"></InputLabel>
        <TextInput
          id="phone"
          v-model="form.phone"
          type="text"
      ...
      <div class="p-3">
        <InputLabel for="department_id" value="Categoria:"></InputLabel>
        <SelectInput
          id="department_id"
          :options="departments"
